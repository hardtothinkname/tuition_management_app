...
export default function Epoint() {
            ...
            <div className="container-fluid py-2">
                <div className="row">
                    <div className="col-6 my-auto">
                        <h4 className="py-2 mb-0 font-weight-bold">Epoint</h4>
                    </div>
                </div>
            </div>
                        ...
                        <form method="post">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-md-9">
                                    <select onchange="select(this, 'epoint');" className="form-control select2 select2-hidden-accessible" id="student" name="student" required="" data-select2-id="student" tabindex="-1" aria-hidden="true">
