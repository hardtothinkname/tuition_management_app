...
const admins = [
    {
        ...
        "Email": "coding",
        "Permission(s)": "Software Developer",
        "Joined Date": "Software Developer"
    },
]
            ...
            return admins.map((item, index) => {
                return (
                    <tr key={index}>
                        ...
                        <td className="text-xs font-weight-bold">{item["Permission(s)"]}</td>
                        <td className="text-xs font-weight-bold">{item['Joined Date']}</td>
                        <td></td>
                    </tr>
                );
            });
                    ...
                    <table id="mytable" className="align-items-center justify-content-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Permission(s)</th>
                                <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Joined Date</th>
                                <th></th>
                            </tr>
                        </thead>
