            ...
            return devices.map((item, index) => {
                return (
                    <tr key={index}>
                        ...
                        <td className="text-xs font-weight-bold">{item.Type}</td>
                        <td className="text-xs font-weight-bold">{item['Last Online']}</td>
                        <td></td>
                    </tr>
                );
            });
                    ...
                    <table id="mytable" className="align-items-center justify-content-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Last Online</th>
                                <th></th>
                            </tr>
                        </thead>
