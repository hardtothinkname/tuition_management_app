import { faBars, faBuilding, faUsers } from '@fortawesome/free-solid-svg-icons';
...
export const NavBar = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light fixed-top" style={{ padding: "2px 1rem" }}>
            <a className="navbar-brand mr-4" href="javascript:void(0)" data-target="#toggle-sidebar"><FontAwesomeIcon icon={faBars} /></a>
            ...
            <div className="collapse navbar-collapse" id="Navbar">
                <ul className="navbar-nav mr-auto">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <a className="dropdown-item" href="https://tuition.robocube.cloud/home/branch_access/168190031021"><i className="fa fa-fw fa-building mr-1"></i> Hanyi test</a>                    <div className="dropdown-divider"></div>
            ...
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown my-auto d-none d-md-inline-block" data-title="Synorex ONE" data-intro="Click here to return to the Robocube License portal">
                    <a className="nav-link mr-1" href="https://account.robocube.cloud/" target="_blank" data-toggle="tooltip" title="" data-original-title="Apps"><i style={{ fontSize: "1.25rem" }} className="fa fa-fw fa-home"></i></a>
                </li>
                ...
                <li className="nav-item dropdown my-auto d-none d-md-inline-block" data-title="Help &amp; Support" data-intro="Click here to view the system manual and ask for help">
                    <a className="nav-link mr-1" href="http://help.synorexcloud.com/" target="_blank" data-toggle="tooltip" title="" data-original-title="Help &amp; Support"><i style={{ fontSize: "1.25rem" }} className="fa fa-fw fa-question-circle"></i></a>
                </li>

                {/* <!--<li className="nav-item dropdown my-auto d-none d-md-inline-block" data-title="Help & Support" data-intro="Click here to view the system manual and ask for help">-->
			<!--	<a className="nav-link mr-1" href="javascript:;" onclick="openPopup('https://tawk.to/chat/60214284a9a34e36b974f700/1eu0unmba')" data-toggle="tooltip" title="Live Chat"><i style="font-size: 1.25rem" className="fa fa-fw fa-comments"></i></a>-->
			<!--</li>--> */}
